 ...
 * generated in the com.why.weather package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://weather.why.com", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://weather.why.com", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.why.weather
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weather.why.com", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weather.why.com", name = "queryWeather")
